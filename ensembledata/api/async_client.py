...
class EDCustomerAsync:
    ...
    async def get_usage(self, date: str, **kwargs):
...
class EDTikTokAsync:
    ...
    async def hashtag_search(self, *, hashtag: str, cursor: int, **kwargs):
        return await self.requester.get(
            "/tt/hashtag/posts",
    ...
    async def user_info_from_username(self, *, username: str, **kwargs):
        params = {
            "username": username,
            **kwargs,
        }
    ...
    async def user_search(self, *, keyword: str, cursor: int, **kwargs):
        params = {
            "keyword": keyword,
            "cursor": cursor,
            **kwargs,
    ...
    async def post_info(self, *, url: str, **kwargs):
    ...
    async def multi_post_info(self, *, post_ids: Sequence[str], **kwargs):
        params = {
            "ids": ",".join(post_ids),
            **kwargs,
        }
    ...
    async def post_comments(self, *, aweme_id: str, cursor: int, **kwargs):
        params = {
            "aweme_id": aweme_id,
            "cursor": cursor,
            **kwargs,
    ...
    async def music_posts(self, *, music_id: str, cursor: int, **kwargs):
        params = {
            "music_id": music_id,
            "cursor": cursor,
            **kwargs,
    ...
    async def music_details(self, *, music_id: str, **kwargs):
        params = {
            "id": music_id,
            **kwargs,
        }
    ...
    async def user_liked_posts(self, *, sec_uid: str, cursor: int, **kwargs):
        params = {
            "secUid": sec_uid,
            "cursor": cursor,
            **kwargs,
...
class EDRedditAsync:
    ...
    async def post_comments(self, *, id: str, cursor: str, **kwargs):
        params = {
            "id": id,
            "cursor": cursor,
            **kwargs,
...
class EDTwitchAsync:
    ...
    async def user_followers(self, *, username: str, **kwargs):
        params = {
            "username": username,
            **kwargs,
        }
...
class EDInstagramAsync:
    ...
    async def user_basic_stats(self, *, user_id: int, **kwargs):
        params = {
            "user_id": user_id,
            **kwargs,
        }
    ...
    async def user_info(self, *, username: str, **kwargs):
        params = {
            "username": username,
            **kwargs,
        }
    ...
    async def user_detailed_info(self, *, username: str, **kwargs):
        params = {
            "username": username,
            **kwargs,
        }
    ...
    async def user_followers(self, *, user_id: int, cursor: int, **kwargs):
        params = {
            "user_id": user_id,
            "cursor": cursor,
            **kwargs,
    ...
    async def music_posts(self, *, music_id: str, cursor: str | None = None, **kwargs):
        params = {
            "music_id": music_id,
            **kwargs,
        }
...
class EDYoutubeAsync:
    ...
    async def featured_category_search(self, *, keyword: str, **kwargs):
        params = {
            "name": keyword,
            **kwargs,
        }
    ...
    async def channel_detailed_info(self, *, channel_id: str, **kwargs):
        params = {
            "browseId": channel_id,
            **kwargs,
        }
    ...
    async def channel_videos(self, *, channel_id: str, depth: int, **kwargs):
        params = {
            "browseId": channel_id,
            "depth": depth,
            **kwargs,
    ...
    async def channel_shorts(self, *, channel_id: str, depth: int, **kwargs):
        params = {
            "browseId": channel_id,
            "depth": depth,
            **kwargs,
    ...
    async def channel_followers(self, *, channel_id: str, **kwargs):
        params = {
            "browseId": channel_id,
            **kwargs,
        }
    ...
    async def channel_username_to_id(self, *, name: str, **kwargs):
        params = {
            "name": name,
            **kwargs,
        }
    ...
    async def channel_id_to_username(self, *, channel_id: str, **kwargs):
        params = {
    ...
    async def video_comments(self, *, id: str, cursor: str, **kwargs):
        params = {
            "id": id,
            "cursor": cursor,
            **kwargs,
...
class EDAsyncClient:
    def __init__(self, token: str):
        self.requester = AsyncRequester(token)
    ...
    async def request(self, uri: str, **kwargs):
